...
// 
    ...
    async function getscience() {
        let { data } = await axios.get('http://api.mediastack.com/v1/news?access_key=fb0205bd85cb4bf4b340149e00629bf9&categories=sports');
                        ...
                        <div className="row lastnews">
                            <div className="col-12">
                                <div className="section-title">
                                    <h4 className="m-0 text-uppercase font-weight-bold">sports</h4>
                            ...
                            {science.length > 12 && (
                                <>
                                    {[...Array(12)].map((_, index) => {
                                        ...
                                        return (
                                            <div className="col-lg-4 imgnews rev2" key={index}>
                            ...
                            <div className="col-lg-12 mb-5 rev2">
                                {science.length > 0 && (
