...
export default function Apple() {
  ...
  async function getTesla() {
    let { data } = await axios.get('https://newsapi.org/v2/everything?q=apple&sortBy=popularity&apiKey=1d8a55dd32754ac2a53f63a870e1e0da');
        ...
        <div className="row">
          <div className="col-lg-8">
            <div className="row lastnews">
              <div className="col-12 rev2">
                <div className="section-title">
                  <h4 className="m-0 text-uppercase font-weight-bold"><Link to="technology">Technology/</Link>Apple</h4>
              ...
              {Tesla.length > 6 && (
                <>
                  {[...Array(6)].map((_, index) => {
                    ...
                    return (<>
                      <div className="col-lg-8 imgnews rev2" key={index}>
                      ...
                      <div className="col-lg-4 rev imgnews" key={index}>
                        <div className="position-relative mb-3">
                          <div className='last-div '>
                            <div className="imghome">
                              <img
          ...
          <div className="col-lg-4">
            ...
            <div className="mb-3 ">
              ...
              <div className="bg-white border border-top-0 p-3 rev2">
                    ...
                    {[...Array(6)].map((_, index) => {
                      ...
                      return (
                        <div className="d-flex align-items-center bg-white mb-3" style={{ height: 110 }} key={index}>
                          ...
                          <div className="w-75 h-100 px-3 overflow-hidden d-flex flex-column justify-content-center border border-left-0">
                            <div className="mb-2">
