...
export default function Old() {
  ...
  async function getTesla() {
    let { data } = await axios.get('https://newsapi.org/v2/everything?domains=wsj.com&apiKey=d37baf4052524cff8cae927d24123632');
            ...
            <div className="row lastnews">
              <div className="col-12">
                <div className="section-title">
                  <h4 className="m-0 text-uppercase font-weight-bold">All articles published by the Wall Street Journal in the last 6 months</h4>
