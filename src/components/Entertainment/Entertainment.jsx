...
export default function Entertainment() {
    ...
    async function getscience() {
        let { data } = await axios.get('http://api.mediastack.com/v1/news?access_key=a34c4e85f7a868ddf51aa3923a7d9d18&categories=entertainment');
                        ...
                        <div className="row lastnews">
                            <div className="col-12">
                                <div className="section-title">
                                    <h4 className="m-0 text-uppercase font-weight-bold">Entertainment</h4>
