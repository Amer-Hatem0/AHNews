...
export default function TechCrunch() {
  ...
  async function getTesla() {
    let { data } = await axios.get('https://newsapi.org/v2/everything?q=sony&sortBy=popularity&apiKey=1d8a55dd32754ac2a53f63a870e1e0da');
            ...
            <div className="row lastnews">
              <div className="col-12">
                <div className="section-title">
                  <h4 className="m-0 text-uppercase font-weight-bold"><Link to="technology">Technology/</Link>Sony</h4>
              ...
              {Tesla.length > 6 && (
                <>
                  {[...Array(6)].map((_, index) => {
                    ...
                    return (<>
                      <div className="col-lg-8 imgnews" key={index}>
