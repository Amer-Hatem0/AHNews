...
export default function Tesla() {
  ...
  async function getTesla() {
    let { data } = await axios.get('https://newsapi.org/v2/everything?q=tesla&sortBy=publishedAt&apiKey=d37baf4052524cff8cae927d24123632');
              ...
              <div className="row lastnews">
                <div className="col-12">
                  <div className="section-title">
                    <h4 className="m-0 text-uppercase font-weight-bold">Tesla</h4>
