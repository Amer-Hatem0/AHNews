...
export default function Science() {
    ...
    async function getscience() {
        let { data } = await axios.get('http://api.mediastack.com/v1/news?access_key=fb0205bd85cb4bf4b340149e00629bf9&categories=health');
                        ...
                        <div className="row lastnews">
                            <div className="col-12">
                                <div className="section-title">
                                    <h4 className="m-0 text-uppercase font-weight-bold">health</h4>
